...
var NotificationsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Notifications'), (0, swagger_1.ApiBearerAuth)('JWT-auth'), (0, common_1.Controller)('notifications')];
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.getMyNotifications = function (req, unreadOnly, limit) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.notificationsService.getUserNotifications(req.user.id, {
        ...
        NotificationsController_1.prototype.getUnreadCount = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.notificationsService.countUnread(req.user.id)];
                        case 1:
                            count = _a.sent();
        ...
        NotificationsController_1.prototype.markAllAsRead = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.notificationsService.markAllAsRead(req.user.id)];
                        case 1:
                            _a.sent();
    ...
    (function () {
        ...
        _getMyNotifications_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Récupérer les notifications de l\'utilisateur connecté' }), (0, swagger_1.ApiQuery)({ name: 'unreadOnly', required: false, type: Boolean }), (0, swagger_1.ApiQuery)({ name: 'limit', required: false, type: Number }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Liste des notifications' })];
        _getUnreadCount_decorators = [(0, common_1.Get)('unread/count'), (0, swagger_1.ApiOperation)({ summary: 'Compter les notifications non lues' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Nombre de notifications non lues' })];
