    ...
    var TransformInterceptor = _classThis = /** @class */ (function () {
        ...
        TransformInterceptor_1.prototype.intercept = function (context, next) {
            ...
            return next.handle().pipe((0, operators_1.map)(function (data) { return ({
                ...
                message: _this.getSuccessMessage(context),
                data: data,
            }); }));
        };
        TransformInterceptor_1.prototype.getSuccessMessage = function (context) {
            var _a;
            var request = context.switchToHttp().getRequest();
            var method = request.method;
            var route = ((_a = request.route) === null || _a === void 0 ? void 0 : _a.path) || '';
