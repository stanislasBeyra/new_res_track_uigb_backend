...
var RefreshToken = function () {
    ...
    var RefreshToken = _classThis = /** @class */ (function () {
        function RefreshToken_1() {
            ...
            this.ipAddress = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _ipAddress_initializers, void 0));
    ...
    (function () {
        ...
        _token_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 500 })];
        ...
        _isRevoked_decorators = [(0, typeorm_1.Column)({ name: 'is_revoked', type: 'boolean', default: false })];
        _createdAt_decorators = [(0, typeorm_1.CreateDateColumn)({ name: 'created_at' })];
        _ipAddress_decorators = [(0, typeorm_1.Column)({ name: 'ip_address', type: 'varchar', length: 45, nullable: true })];
        _userAgent_decorators = [(0, typeorm_1.Column)({ name: 'user_agent', type: 'varchar', length: 255, nullable: true })];
