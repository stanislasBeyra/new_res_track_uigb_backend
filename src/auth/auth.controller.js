...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.login = function (loginDto, ipAddress, req) {
            return __awaiter(this, void 0, void 0, function () {
                var userAgent;
                return __generator(this, function (_a) {
                    userAgent = req.headers['user-agent'];
                    return [2 /*return*/, this.authService.login(loginDto, ipAddress, userAgent)];
                });
            });
        };
        AuthController_1.prototype.refresh = function (refreshTokenDto, ipAddress, req) {
            return __awaiter(this, void 0, void 0, function () {
                var userAgent;
                return __generator(this, function (_a) {
                    userAgent = req.headers['user-agent'];
                    return [2 /*return*/, this.authService.refreshAccessToken(refreshTokenDto.refreshToken, ipAddress, userAgent)];
                });
            });
        };
        AuthController_1.prototype.logout = function (refreshTokenDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.logout(refreshTokenDto.refreshToken)];
                });
            });
        };
    ...
    (function () {
        ...
        _login_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Se connecter avec email et mot de passe' }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: 'Login successful',
                type: auth_response_dto_1.AuthResponseDto,
            }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid credentials' })];
        _refresh_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('refresh'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Rafraîchir le token d\'accès' }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: 'Token refreshed successfully',
                type: auth_response_dto_1.AuthResponseDto,
            }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid or expired refresh token' })];
        _logout_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('logout'), (0, common_1.HttpCode)(common_1.HttpStatus.NO_CONTENT), (0, swagger_1.ApiOperation)({ summary: 'Se déconnecter et révoquer le refresh token' }), (0, swagger_1.ApiResponse)({ status: 204, description: 'Logout successful' })];
