...
var SubscribeTopicDto = function () {
    var _a;
    var _topic_decorators;
    var _topic_initializers = [];
    var _topic_extraInitializers = [];
    return _a = /** @class */ (function () {
            function SubscribeTopicDto() {
                this.topic = __runInitializers(this, _topic_initializers, void 0);
                __runInitializers(this, _topic_extraInitializers);
            }
            return SubscribeTopicDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _topic_decorators = [(0, swagger_1.ApiProperty)({ description: 'Nom du topic', example: 'exits_notifications' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
