...
var RegisterTokenDto = function () {
    ...
    return _a = /** @class */ (function () {
            function RegisterTokenDto() {
                this.token = __runInitializers(this, _token_initializers, void 0);
                this.deviceType = (__runInitializers(this, _token_extraInitializers), __runInitializers(this, _deviceType_initializers, void 0));
                this.deviceId = (__runInitializers(this, _deviceType_extraInitializers), __runInitializers(this, _deviceId_initializers, void 0));
                this.topics = (__runInitializers(this, _deviceId_extraInitializers), __runInitializers(this, _topics_initializers, void 0));
        ...
        (function () {
            ...
            _token_decorators = [(0, swagger_1.ApiProperty)({ description: 'FCM Token du device', example: 'dXq7K8...' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _deviceType_decorators = [(0, swagger_1.ApiProperty)({ description: 'Type de device', example: 'android', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _deviceId_decorators = [(0, swagger_1.ApiProperty)({ description: 'ID unique du device', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _topics_decorators = [(0, swagger_1.ApiProperty)({ description: 'Topics FCM', type: [String], required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)()];
